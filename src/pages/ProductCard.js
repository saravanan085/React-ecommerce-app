            ...
            <Row>
                {
                    products.map((item) => {
                        return (
                            <Col lg='3' md='3' sm='6' xs='12' xl='3' className='box d-flex justify-content-center align-items-center mb-2'>
                                ...
                                <div className='product_item d-flex flex-column justify-content-center align-items-end mx-3'>
                                    ...
                                    <div className="product_desc">
                                        <div className='product_name'><Link to='/shop/id'>{item.product_name}</Link></div>
